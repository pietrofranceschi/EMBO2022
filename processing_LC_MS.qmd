...
3. We have been running peal picking on the full set of samples
4. We have been saving the output somewhere, just to avoid re-starting from scratch ;-)

## What Next

We have to merge the lists of <span style="color: red">chromatographic peaks</span> into a consensus list of <span style="color: red"> features peaks</span>, which will be the column of our data matrix
...
Since QC samples are the same, all variability seen there is analytical. 

![](images/workflow.svg){width=60% fig-align="center"}
